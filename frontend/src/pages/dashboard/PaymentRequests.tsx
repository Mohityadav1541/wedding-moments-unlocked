...
import { Loader2, Check, X, Smartphone, Calendar, Search } from "lucide-react";
...
const PaymentRequests = () => {
    ...
    const filteredRequests = requests.filter(req =>
        ...
        req.event?.name?.toLowerCase().includes(searchTerm.toLowerCase())
    );
                            ...
                            {filteredRequests.length === 0 ? (
                                ...
                                filteredRequests.map((req) => (
                                    <TableRow key={req._id}>
                                        ...
                                        <TableCell className="font-medium">{req.event?.name || 'Unknown'}</TableCell>
                                        <TableCell>
                                            <div className="flex flex-col">
                                                <span className="text-sm">{req.guestEmail || 'No Email'}</span>
                                            </div>
                                        </TableCell>
                                        <TableCell>
                                            <div className="flex items-center gap-2">
                                        ...
                                        <TableCell>
                                            ...
                                            <span className="text-muted-foreground text-xs ml-1">({req.photos.length} photos)</span>
                                        </TableCell>
                                        <TableCell>
                                            <Badge variant={
