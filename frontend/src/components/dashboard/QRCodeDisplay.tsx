...
const QRCodeDisplay = ({ eventId, eventName, size = 200 }: QRCodeDisplayProps) => {
  ...
  return (
    <div className="bg-card rounded-xl p-6 border border-border/50 shadow-card text-center">
      ...
      <p className="font-body text-sm text-muted-foreground mb-4 break-all">
        {eventUrl}
      </p>
