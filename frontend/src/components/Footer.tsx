        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-background/60 font-body tracking-wider">
                  Photo Finder
                </span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 font-body text-sm">
              ...
              <li>
                <Link to="/event/demo" className="text-background/70 hover:text-primary transition-colors">
                  Try Demo
                </Link>
              </li>
            </ul>
          ...
          {/* For Photographers */}
          <div>
            <h4 className="font-display text-lg font-semibold mb-4">For Photographers</h4>
            <ul className="space-y-3 font-body text-sm">
              <li>
